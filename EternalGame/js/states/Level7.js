...
Level7.prototype = {
	...
	create:function(){
		...
		//add the block
		block = game.add.sprite(370,130, 'key', 'block');
		...
		pollblock.scale.setTo(2, 2);
		pollblock.body.gravity.y = 1000;
		pollblock.body.drag.setTo(1000, 0);
	...
	update:function(){
		...
		game.physics.arcade.collide(block, this.pollutionGroup);
